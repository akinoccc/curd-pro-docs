import{N as F,b as q,d as G,a as j,e as J,c as U}from"./mock-dicts-DaoPAJwu.js";import{m as Q,n as _,p as w,q as b,s as W,v as X,x as C,y as g,d as B,l as h,z as Y,A as Z,C as E,D as ee,E as oe,g as H,F as re,G as le,k as te,H as se,f as y,c as M,a as i,w as a,u as l,i as ie,b as u,N as x,j as S,B as P,t as k,e as L,I as ae,J as ne,K as de,o as z}from"./index-C_iRN830.js";import{u as ce}from"./use-message-B2KrddAV.js";function ue(o){const{textColor2:e,cardColor:s,modalColor:d,popoverColor:c,dividerColor:v,borderRadius:p,fontSize:t,hoverColor:f}=o;return{textColor:e,color:s,colorHover:f,colorModal:d,colorHoverModal:_(d,f),colorPopover:c,colorHoverPopover:_(c,f),borderColor:v,borderColorModal:_(d,v),borderColorPopover:_(c,v),borderRadius:p,fontSize:t}}const ve={common:Q,self:ue},pe=w([b("list",`
